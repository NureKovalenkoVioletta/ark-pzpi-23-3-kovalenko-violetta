...
public class StatisticsService : IStatisticsService
{
    ...
    private async Task<TelemetryAggregateDto> AggregateTelemetryForDay(List<int> deviceIds, DateTime date)
    {
        ...
        // Кроки: рахуємо загальну кількість кроків за останні 24 години
        // Клієнт відправляє окремі інкременти кроків, тому просто сумуємо всі значення за день
        decimal steps = stepsSamples.Sum(s => s.TelemetryValue);

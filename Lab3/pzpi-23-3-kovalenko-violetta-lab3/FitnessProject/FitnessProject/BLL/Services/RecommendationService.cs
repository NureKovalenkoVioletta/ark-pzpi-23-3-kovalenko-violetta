...
public class RecommendationService : IRecommendationService
{
    ...
    public async Task<RecommendationDetailsDto?> GetRecommendationDetailsByIdAsync(int id)
    {
        var entity = await _repository.GetRecommendationDetailsByIdAsync(id);
        return entity == null ? null : _mapper.Map<RecommendationDetailsDto>(entity);
    }

...
public class TemplateDietPlanService : ITemplateDietPlanService
{
    ...
    public async Task<TemplateDietPlanDetailsDto?> GetTemplateDietPlanDetailsByIdAsync(int id)
    {
        var entity = await _repository.GetTemplateDietPlanDetailsByIdAsync(id);
        return entity == null ? null : _mapper.Map<TemplateDietPlanDetailsDto>(entity);
    }

...
public class MealService : IMealService
{
    ...
    public async Task<MealDetailsDto?> GetMealDetailsByIdAsync(int id)
    {
        var entity = await _repository.GetMealDetailsByIdAsync(id);
        return entity == null ? null : _mapper.Map<MealDetailsDto>(entity);
    }

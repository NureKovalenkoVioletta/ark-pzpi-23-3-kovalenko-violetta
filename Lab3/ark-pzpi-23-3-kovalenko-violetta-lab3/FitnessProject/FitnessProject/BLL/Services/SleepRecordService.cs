...
public class SleepRecordService : ISleepRecordService
{
    ...
    public async Task<SleepRecordDetailsDto?> GetSleepRecordDetailsByIdAsync(int id)
    {
        var entity = await _repository.GetSleepRecordDetailsByIdAsync(id);
        return entity == null ? null : _mapper.Map<SleepRecordDetailsDto>(entity);
    }

...
namespace FitnessProject.Migrations
{
    ...
    [Migration("20251215154110_AddGoalTypeAndMealRecipePortions")]
    partial class AddGoalTypeAndMealRecipePortions
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FitnessProject.Entities.MealRecipe", b =>
                {
                    ...
                    b.Property<string>("PortionsMetadata")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("portions_metadata");
